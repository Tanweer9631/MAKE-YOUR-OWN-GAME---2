class Game {
  ...
  start() {
    ...
    bike1.scale = 0.07;
    bike1.addImage("blast", blastImage); //C42 //SA

    bike2 = createSprite(width / 2 + 200, height - 100);
    bike2.addImage("bike2", bike2_img);
    bike2.scale = 0.07;
    bike2.addImage("blast", blastImage); //C42//SA

    bike3 = createSprite(width / 2 - 250, height - 100);
    bike3.addImage("bike3", bike3_img);
    bike3.scale = 0.07;
    bike3.addImage("blast", blastImage); //C42//SA

    bike4 = createSprite(width / 2 + 300, height - 100);
    bike4.addImage("bike2", bike2_img);
    bike4.scale = 0.07;
    bike4.addImage("blast", blastImage); //C42//SA
  ...
  handleObstacleCollision(index) {
    if(bikes[index-1].collide(obstacle1)||bikes[index-1].collide(obstacle2)){
